...
class AuthorListViewTest(TestCase):
    ...
    def setUpTestData(cls):
        # Create 13 authrors for pagination tests
    ...
    def test_view_url_exists_at_deisred_location(self):
...
class AuthorCreateViewTest(TestCase):
    def setUp(self):
        ...
        # Give test_user2 permission to create am author
    ...
    def test_view_only_accessible_to_users_with_permission(self):
        login = self.client.login(username='testuser2', password='2HJ1vRV0Z&3iD')
        response = self.client.get(reverse("author-create"))
        self.assertEqual(response.status_code, 200)
    
    def test_create_author_with_valid_form_data(self):
        login = self.client.login(username='testuser2', password='2HJ1vRV0Z&3iD')
        # Define form data
        form_data = {
            'first_name': 'John',
        ...
        # Check that a new author instance has been created in the database
        self.assertEqual(Author.objects.count(), 1)
        new_author = Author.objects.first()
        self.assertEqual(new_author.first_name, 'John')
        self.assertEqual(new_author.last_name, 'Doe')
        self.assertEqual(str(new_author.date_of_birth), '1990-01-01')
        # self.assertEqual(str(new_author.date_of_death), '2020-01-01')
        
        # Check that the user is redirected to the author detail view for the new author instance
    ...
    def test_form_date_of_death_initial_value(self):
        ...
        self.assertEqual(response.context['form'].initial['date_of_death'], '05/01/2023')
...
class LoanedBookInstancesByUserListViewTest(TestCase):
    ...
    def test_only_borrowed_books_in_list(self):
        ...
        # Check our user is logged in
        self.assertEqual(str(response.context["user"]), "testuser1")
        # Cehck that we got a response "success"
        self.assertEqual(response.status_code, 200)
...
class RenewBookInstancesViewTest(TestCase):
    ...
    def test_redirect_if_not_logged_in(self):
        ...
        # Manually check redirect (Can't use assertRedirect, because teh redirect URL is unpredictable)
        self.assertEqual(response.status_code, 302)
