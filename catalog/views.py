...
class BookInstanceCreateView(LoginRequiredMixin, CreateView):
    ...
    def get_initial(self):
        ...
        initial["book"] = get_object_or_404(
            Book, id=self.kwargs["book_id"]
        )  # Set book to clicked book
        return initial
...
#         message = Mail(
#             from_email="daniel@tedprimehub.org",
#             to_emails=form.cleaned_data["email"],
#             subject="Reset your password",
#             html_content=self.render_to_string(
#                 self.template_name,
#                 {"user": form.user, "reset-url": self.get_reset_url(form)},
#             ),
#         )
#         try:
